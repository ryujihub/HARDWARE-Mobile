      ...
      <View style={styles.section}>
        ...
        <View style={styles.settingItem}>
          <View style={styles.settingInfo}>
            ...
            <Text style={styles.settingDescription}>Currency used for all monetary values</Text>
          </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.settingItem}>
          <View style={styles.settingInfo}>
            ...
            <Text style={styles.settingDescription}>How often the app updates inventory data</Text>
          </View>
